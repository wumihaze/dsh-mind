...
- **memory-review nudge is much less chatty**: the default reminder interval
  was raised from every 8 assistant steps to every 50, so long sessions stop
  getting nagged to review memory when there is nothing new worth persisting.
